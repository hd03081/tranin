<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.*,java.lang.*,com.toy.runeah.simpleWebServlet.dao.MainDao"%>
<%@ taglib prefix="c"
...
<body>
        ...
        <ul id="gnbList">
          ...
          <%
            ...
            <ul class="snb">
              <li><a href="#">후기</a></li>
              <li><a href="#">인기글</a></li>
              <li><a href="/runeah/freeBoard">자유게시판</a></li>
  ...
  <main>
    ...
    <section class="page2Wrap_sh pageWrap_sh onePage2">
      <div class="page2 page">
        ...
        <div id="PCSliderWrap_sh" class="see">
          <img src="/img/pc.svg" alt="PC의 모습" class="img">
        ...
        <div id="MSliderWrap_sh" class="unsee">
          <img src="/img/phone.svg" alt="mobile의 모습" class="img">
          <ul class="MSlider_sh">
    ...
    <!-- 유수현 영역1 끝 -->
    <section id="Wrap_hj" class="onePage3">
      <div class="firstDiv_hj">
        <div id="headerWrap_hj">
          <h2 class="Header_hj">최근 올라온 판매 상품!</h2>
  ...
  <div class="footerWrap page onePage6">
    <footer class="page8" id="footer">
      ...
      <div id="membersWrap">
        ...
        <p class="member4_sh member_sh"><a href="suhyun.html" target="_blank">유수현</a></p>
